...
def generate(
    ...
    while True:
        try:
            ...
            # Format user input
            formatted_input = template_input(user_input)

            # Output result
            generator.generate(formatted_input)

        except EOFError:
            # Handle EOFError (Ctrl+D on Unix-like systems)
            print("\nExiting...")
            break
...
# python run_echo.py --max_output_len=300 --tokenizer_dir "C:\Users\Grant\Desktop\TensorRTInstall\Llama-2-7b-chat-hf" --engine_dir=".\engines" --streaming